  ...
  // Vector3[] vertices;
   // Mesh mesh ;
    ...
    //    Vector3[] vertices = mesh.vertices;
       ...
       //string animName;
  //public  AnimationClip  monClip;
 // var gun= GetComponent("Voiture_001") ;
  
// print("gun.GetComponent<AnimationClip>()"+gun.GetComponent<AnimationClip>());
//gun.AddComponent<Animation>();
 // gun.GetComponent<Animation>().Play();

//print("titi");
//animName  ="teufteuf";
 //gun.GetComponent<Animation>().AddClip( monClip,  animName); 
 //gun.GetComponent<Animation>().Play("teufteuf");

//AnimationClipCurveData[] curveDatas = AnimationUtility.GetAllCurves(monClip, true);
/* for (int i=0; i<curveDatas.Length; i++) {

       
             //curveDatas[i].path,
             print(curveDatas[i].type);
             //curveDatas[i].propertyName,
            print( curveDatas[i].curve);
} */
//: 'AnimationUtility.GetAllCurves(AnimationClip, bool)' is obsolete: 'GetAllCurves is deprecated.
 //Use GetCurveBindings and GetObjectReferenceCurveBindings instead.'
 //AnimationClipCurveData[] curveDatas = AnimationUtility.GetCurveBindings(monClip);
 //var curveDatas = AnimationUtility.GetCurveBindings(monClip);print(curveDatas);


 //var anim=gun.GetComponents<Animator>();
 // print("animator="+anim[0]);

// Animation animation = GetComponent<Animation>();
//print("animation="+animation);
//hingeJoints = GetComponents(typeof(Animation));
// var  anim1 = GetComponent<Animation>();
...
//gun=GetComponent<GameObject>().GameObject=Voiture_00; 
    ...
    print(vertices.Length);
       ...
       for (var i = 0; i < vertices.Length; i++)
        ...
        ///////////////////////////////
      // var animation = gun.GetComponent<Animation>();
       //print(animation);